...
export function StreamlinedClipboard() {
   ...
   const handleTextSubmit = async () => {
    ...
    if(inputContent === "" || inputContent === null){
      ...
      setIsAlertVisible({
        ...
        if(isEncrypted == true){
          try {
            const response = await axios.post(`https://my-database-app-v1.onrender.com/api/encrypted/save`, {
              "createdUserRid": null,
             "deletedByUser": false,
          ...
          try {
            const response = await axios.post(`https://my-database-app-v1.onrender.com/api/post/text`, {
              "createdUserRid": null,
             "deletedByUser": false,
  ...
  const handleReceive =async () => {
    ...
    try {
      const response = await axios.get(`https://my-database-app-v1.onrender.com/api/encrypted/retrieve/${enteredotp.toString()}`);
