...
export default function Navbar() {
  return (
    <div>
        <nav class="bg-white border-gray-200 shadow-md mb-6 dark:bg-gray-900 dark:border-gray-700">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        
        <span class="self-center text-2xl ml-10 font-serif whitespace-nowrap dark:text-white">FOR YOU CLIPBOARD</span>
    </a>
